...
class CowsControllerTest < ActionController::TestCase
  ...
  test "should create cow" do
    assert_difference('Cow.count') do
      post :create, cow: { life: @cow.life, maker: @cow.maker, origin: @cow.origin, price: @cow.price, title: @cow.title, weight: @cow.weight }
    end
  ...
  test "should update cow" do
    patch :update, id: @cow, cow: { life: @cow.life, maker: @cow.maker, origin: @cow.origin, price: @cow.price, title: @cow.title, weight: @cow.weight }
    assert_redirected_to cow_path(assigns(:cow))
  end
